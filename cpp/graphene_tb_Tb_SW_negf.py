...
_cpp_dir = os.path.join(_repo_dir)  # already inside cpp
...
def parse_args():
    ...
    p.add_argument("--Vimp_eta2",type=float,default=0.20)  # MCMC optimized
    p.add_argument("--Vimp_side",type=float,default=0.2)
    p.add_argument("--Vimp_pr",type=float,default=0.20)  # MCMC optimized
    ...
    p.add_argument("--alpha1_sw",type=float,default=2.0e-15)   # 10 meV per V/Å (realistic for defect states)  
    p.add_argument("--alpha2_sw",type=float,default=5.0e-21) # Quadratic coupling for field-induced distortion
    p.add_argument("--eps_pr",type=float,default=0.048150)  # MCMC optimized
    p.add_argument("--alpha1_pr",type=float,default=2.0e-15)  # Smaller coupling for pristine (no defect enhancement)
    p.add_argument("--alpha2_pr",type=float,default=-5.0e-21) # Weaker quadratic term for pristine
