...
Author: Custom KWANT replacement
...
def info():
    ...
    import scipy
    print(f"YQT Quantum Transport Library v{__version__}")
...
if __name__ == "__main__":
    print("=" * 70)
    print("YQT - Quantum Transport Library")
    print("=" * 70)
    print()
    ...
    print("Computing transmission at test energies...")
